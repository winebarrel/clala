...
Lambda.prototype.lambda = function(handler, callback) {
  var self = this;
...
Lambda.prototype.cleanup = function() {
  var self = this;
...
Lambda.prototype._createLocalFunction = function(functionName) {
  var self = this;
...
Lambda.prototype._zipFuction = function(functionName, handler) {
...
Lambda.prototype._startReceiveMessage = function() {
  var self = this;
...
Lambda.prototype._callbackLocalFunction = function(json) {
