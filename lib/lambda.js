...
var Lambda = {
  ...
  lambda: function(handler, callback) {
    var self = this;
  ...
  _createLocalFunction: function(functionName) {
    var self = this;
  ...
  _zipFuction: function(functionName, handler) {
    ...
    zip.file('evaluate.js', fs.readFileSync(__dirname + '/evaluate.js', 'utf8'));
    zip.file('env.js', fs.readFileSync(__dirname + '/env.js', 'utf8'));

    return zip.generate({base64:false, compression:'DEFLATE', type: 'nodebuffer'});
  },

  _startReceiveMessage: function() {
    var self = this;
  ...
  _callbackLocalFunction: function(json) {
